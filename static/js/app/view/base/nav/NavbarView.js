define(function(require) {
	...
	var navdata = require('app/view/base/nav/nav');
	
    return Gonrin.View.extend({
    		//data: navdata,

	    	checkUserHasRole: function(rolename) {
	    		console.log("111, ", gonrinApp().currentUser);
	    		console.log("abc, ", gonrinApp().currentUser.hasRole(rolename));
				...
				_.each(entries, function(entry, index) {
					...
					if (entry_type === "category") {
						...
						if (entry_icon) {
							...
							_html = _html + `<i class="${entry_icon}"></i> `;
						}
